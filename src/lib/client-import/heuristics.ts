...
const ALIASES: Record<CredprontoColumn, string[]> = {
  ...
  mail_inquilino: ["mail", "email", "mailinquilino", "emailinquilino", "emaildocliente", "correioeletronico"],
  telefone_inquilino: ["telefone", "celular", "fone", "telefoneinquilino", "telinquilino", "whatsapp", "tel"],
  ...
  valor_taxas: ["valortaxas", "taxas", "valordastaxas", "iptu"],
  produto_fianca_loft: ["produtofiancaloft", "fianca", "produtofianca", "produto"],
  taxa_setup: ["taxasetup", "setup", "taxadeinstalacao"],
  meio_pagamento: ["meiopagamento", "formapagamento", "pagamento", "meiodepagamento"],
  ramo: ["ramo", "segmento"],
